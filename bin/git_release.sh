...
git push --quiet origin_gh HEAD:release > /dev/null 2>&1 || echo "Failed to push to release branch"

git tag v${VERSION_NUMBER}
git push --quiet origin_gh v${VERSION_NUMBER} > /dev/null 2>&1 || echo "Failed to push tag"
