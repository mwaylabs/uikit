  ...
  .directive('mwListableHeaderRowBb', function () {
    return {
      ...
      compile: function (elm) {
        ...
        elm.append('<th ng-if="actionColumns.length > 0" colspan="{{ actionColumns.length }}" width="1%" class="action-button"><div ng-if="enableConfigurator" mw-list-column-configurator></div></th>');
